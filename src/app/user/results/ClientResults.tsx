...
function getDynamicTests(organism: string, lang: "en" | "bn") {
  ...
  if (
    orgLow.includes("sars") ||
    orgLow.includes("covid") ||
    orgLow.includes("corona")
  ) {
    return [
      {
        icon: "🔬",
        ...
        desc:
          lang === "bn"
            ? "শরীরে সক্রিয় ভাইরাসের উপস্থিতি নিশ্চিত করতে ব্যবহৃত প্রধান পরীক্ষা।"
            : "Gold standard test to confirm active viral infection.",
        price: "৳১,৫০০",
      },
      {
        icon: "🫁",
        ...
        desc:
          lang === "bn"
            ? "ফুসফুসের সংক্রমণ এবং নিউমোনিয়ার লক্ষণ যাচাই করার জন্য।"
            : "Check for signs of lung infection and pneumonia.",
        price: "৳৬০০",
      },
      {
        icon: "🩸",
        ...
        desc:
          lang === "bn"
            ? "রক্তের শ্বেত রক্তকণিকা এবং অন্যান্য উপাদানের মাত্রা চেক করতে।"
            : "Check white blood cell counts and overall blood health.",
        price: "৳৪০০",
      },
    ];
    ...
    return [
      {
        ...
        desc:
          lang === "bn"
            ? "রোগ প্রতিরোধ ক্ষমতার বর্তমান অবস্থা পরিমাপ করতে।"
            : "Measure the current state of the immune system.",
        price: "৳১,৮০০",
      },
      {
        icon: "🦠",
        ...
        desc:
          lang === "bn"
            ? "রক্তে ভাইরাসের পরিমাণ পরিমাপ করার পরীক্ষা।"
            : "Measure the amount of virus present in the blood.",
        price: "৳৩,৫০০",
      },
      {
        icon: "🧪",
        ...
        desc:
          lang === "bn"
            ? "সাধারণ শারীরিক অবস্থা ও রক্তের উপাদান পরিমাপ করতে।"
            : "General physical condition and blood component measurement.",
        price: "৳৪০০",
      },
    ];
    ...
    return [
      {
        ...
        desc:
          lang === "bn"
            ? "স্তন ক্যানসারের প্রাথমিক লক্ষণ শনাক্ত করার জন্য।"
      ...
      },
      {
        ...
        desc:
          lang === "bn"
            ? "স্তনের টিস্যুর বিস্তারিত ছবি প্রদান করে।"
            : "Provides detailed imaging of breast tissues.",
        price: "৳১,৫০০",
      },
      {
        icon: "🩸",
        ...
        desc:
          lang === "bn"
            ? "রক্তে ক্যানসার মার্কারের মাত্রা পরিমাপ করতে।"
            : "Measures levels of cancer markers in the blood.",
        price: "৳১,২০০",
      },
    ];
  }
  ...
  return [
    {
      ...
      desc:
        lang === "bn"
          ? "রক্তের সাধারণ স্বাস্থ্য এবং সংক্রমণ শনাক্ত করার পরীক্ষা।"
          : "General blood health and infection detection.",
      price: "৳৪০০",
    },
    {
      icon: "🧪",
      ...
      desc:
        lang === "bn"
          ? "রক্তে কোলেস্টেরল এবং ট্রাইগ্লিসারাইডের মাত্রা পরিমাপ করতে।"
    ...
    },
    {
      ...
      desc:
        lang === "bn"
          ? "রক্তে শর্করার মাত্রা পরীক্ষা করতে।"
          : "Checks blood sugar levels after fasting.",
      price: "৳২৫০",
    },
  ];
}
...
function getNextStep(sev: Severity, lang: "en" | "bn"): string {
  if (lang === "en") {
    if (sev === "high")
      return "Please consult a healthcare professional for a detailed evaluation.";
    if (sev === "medium")
      return "Mention this at your next doctor's appointment to keep an eye on it.";
    return "Keep up with your regular routine and healthy habits.";
  } else {
    if (sev === "high")
      return "বিস্তারিত মূল্যায়নের জন্য অনুগ্রহ করে একজন স্বাস্থ্যসেবা পেশাদারের পরামর্শ নিন।";
    if (sev === "medium")
      return "নজরে রাখতে আপনার পরবর্তী ডাক্তারের অ্যাপয়েন্টমেন্টে এটি উল্লেখ করুন।";
...
const EN_OVERALL_CONFIG_PATIENT = {
  low: {
    label: "All Clear — No Major Findings",
    emoji: "✅",
    bg: "rgba(16, 185, 129, 0.08)",
    border: "rgba(16, 185, 129, 0.25)",
  },
  moderate: {
    label: "Some Findings — Worth Discussing",
    emoji: "⚠️",
    bg: "rgba(234, 179, 8, 0.08)",
    border: "rgba(234, 179, 8, 0.25)",
  },
  high: {
    label: "Action Needed — Please Consult a Doctor",
    emoji: "🔴",
...
const BN_OVERALL_CONFIG_PATIENT = {
  low: {
    label: "সব ঠিক আছে — কোনো বড় ঝুঁকি নেই",
    emoji: "✅",
    bg: "rgba(16, 185, 129, 0.08)",
    border: "rgba(16, 185, 129, 0.25)",
  },
  moderate: {
    label: "কিছু তথ্য পাওয়া গেছে — আলোচনা করা উচিত",
    emoji: "⚠️",
    bg: "rgba(234, 179, 8, 0.08)",
    border: "rgba(234, 179, 8, 0.25)",
  },
  high: {
    label: "পদক্ষেপ নিন — অনুগ্রহ করে ডাক্তারের পরামর্শ নিন",
    emoji: "🔴",
    bg: "rgba(244, 63, 94, 0.08)",
    border: "rgba(244, 63, 94, 0.25)",
  },
...
const EN_OVERALL_CONFIG_COORDINATOR = {
  low: {
    label: "Typical Risk — Standard Monitoring",
    emoji: "✅",
    bg: "rgba(16, 185, 129, 0.08)",
    border: "rgba(16, 185, 129, 0.25)",
  },
  moderate: {
    label: "Elevated Risk — Specialist Referral Recommended",
    emoji: "⚠️",
    bg: "rgba(234, 179, 8, 0.08)",
    border: "rgba(234, 179, 8, 0.25)",
  },
  high: {
    label: "Critical Risk Found — Action Recommended",
    emoji: "🔴",
    bg: "rgba(244, 63, 94, 0.08)",
    border: "rgba(244, 63, 94, 0.25)",
  },
...
const BN_OVERALL_CONFIG_COORDINATOR = {
  low: {
    label: "স্বাভাবিক ঝুঁকি — নিয়মিত পর্যবেক্ষণ",
    emoji: "✅",
    bg: "rgba(16, 185, 129, 0.08)",
    border: "rgba(16, 185, 129, 0.25)",
  },
  moderate: {
    label: "উচ্চতর ঝুঁকি — বিশেষজ্ঞের কাছে রেফারেল সুপারিশকৃত",
    emoji: "⚠️",
    bg: "rgba(234, 179, 8, 0.08)",
    border: "rgba(234, 179, 8, 0.25)",
  },
  high: {
    label: "গুরুতর ঝুঁকি পাওয়া গেছে — পদক্ষেপ নেওয়া জরুরি",
    emoji: "🔴",
    bg: "rgba(244, 63, 94, 0.08)",
    border: "rgba(244, 63, 94, 0.25)",
  },
...
const EN_UI_PATIENT = {
  ...
  noResultsDesc:
    "Your genetic analysis is not available yet. Please contact your care coordinator or doctor for details.",
  ...
  healthInsightsHint:
    "These insights are based on your genetic file and approved by your healthcare provider.",
  nextStep: "Next Step:",
  downloadBtn: "📄 Download PDF Report",
  uploadNewBtn: "🧬 Upload New DNA File",
  disclaimer:
    "Important: These results are based on genetic markers only and are not a medical diagnosis. Always consult a qualified healthcare professional before making any health decisions.",
...
const BN_UI_PATIENT = {
  ...
  loadingHint:
    "আমরা আপনার জেনেটিক ডেটা প্রসেস করার সময় অনুগ্রহ করে অপেক্ষা করুন।",
  errorTitle: "ফলাফল লোড করা যায়নি",
  noResultsTitle: "এখনও কোন ফলাফল নেই",
  noResultsDesc:
    "আপনার জেনেটিক বিশ্লেষণ এখনও প্রস্তুত নয়। বিস্তারিত জানার জন্য আপনার কেয়ার কোঅর্ডিনেটর বা ডাক্তারের সাথে যোগাযোগ করুন।",
  ...
  healthInsightsHint:
    "এই তথ্যগুলি আপনার আপলোড করা ডিএনএ ফাইলের উপর ভিত্তি করে এবং আপনার স্বাস্থ্যসেবা প্রদানকারী দ্বারা অনুমোদিত।",
  nextStep: "পরবর্তী পদক্ষেপ:",
  downloadBtn: "📄 পিডিএফ রিপোর্ট ডাউনলোড করুন",
  uploadNewBtn: "🧬 নতুন ডিএনএ ফাইল আপলোড করুন",
  disclaimer:
    "গুরুত্বপূর্ণ: এই ফলাফলগুলি শুধুমাত্র জেনেটিক তথ্যের উপর ভিত্তি করে এবং এটি কোনো মেডিকেল ডায়াগনোসিস নয়। স্বাস্থ্য সংক্রান্ত কোনো সিদ্ধান্ত নেওয়ার আগে সর্বদা একজন যোগ্য চিকিৎসকের পরামর্শ নিন।",
...
const EN_UI_COORDINATOR = {
  ...
  noResultsDesc:
    "No patient DNA file has been uploaded yet, or the analysis is still in progress. Upload a patient DNA file to generate the clinical risk report.",
  ...
  healthInsightsHint:
    "These diagnostic risk assessments are generated from the query sequence aligned against reference databases.",
  nextStep: "Recommended Action:",
  downloadBtn: "📄 Export Clinical Report (PDF)",
  uploadNewBtn: "🧬 Upload New Patient DNA",
  disclaimer:
    "Important: This is a decision-support report designed for clinical users. It must be interpreted in conjunction with other clinical signs and confirmatory testing.",
  translateBtn: "বাংলা অনুবাদ",
  confidence: "Confidence",
  trend: "Trend",
};
...
const BN_UI_COORDINATOR = {
  ...
  loadingHint:
    "আমরা জিনোমিক সিকোয়েন্স ডেটা প্রসেস করার সময় অনুগ্রহ করে অপেক্ষা করুন।",
  errorTitle: "বিশ্লেষণ লোড করা যায়নি",
  noResultsTitle: "এখনও কোনো নমুনা নেই",
  noResultsDesc:
    "কোনো রোগীর ডিএনএ ফাইল এখনও আপলোড করা হয়নি, অথবা বিশ্লেষণ চলছে। ক্লিনিক্যাল ঝুঁকি রিপোর্ট তৈরি করতে রোগীর ডিএনএ ফাইল আপলোড করুন।",
  ...
  healthInsightsHint:
    "এই ডায়াগনস্টিক ঝুঁকি মূল্যায়নগুলি রেফারেন্স ডেটাবেসের সাথে সিকোয়েন্স ম্যাচ করে তৈরি করা হয়েছে।",
  nextStep: "সুপারিশকৃত পদক্ষেপ:",
  downloadBtn: "📄 ক্লিনিক্যাল রিপোর্ট এক্সপোর্ট (পিডিএফ)",
  uploadNewBtn: "🧬 রোগীর নতুন ডিএনএ আপলোড করুন",
  disclaimer:
    "গুরুত্বপূর্ণ: এটি ক্লিনিক্যাল ব্যবহারকারীদের জন্য ডিজাইন করা একটি সিদ্ধান্ত-সহায়তা রিপোর্ট। এটি অন্যান্য ক্লিনিক্যাল লক্ষণ এবং নিশ্চিতকরণ পরীক্ষার সাথে মিলিয়ে ব্যাখ্যা করতে হবে।",
  translateBtn: "English",
  confidence: "আত্মবিশ্বাস",
  trend: "প্রবণতা",
};
...
function formatPriceBn(num: number): string {
  const digitsMap: Record<string, string> = {
    "0": "০",
    "1": "১",
    "2": "২",
...
function formatPriceEn(num: number): string {
  return "৳" + num.toLocaleString("en-US");
}

function calculateTotalBill(bookings: any[]): number {
  return bookings.reduce((sum, b) => sum + parsePrice(b.price), 0);
}
...
export default function ClientResults({
  ...
  const OVERALL_CONF = isBn
    ? isCoordinator
      ? BN_OVERALL_CONFIG_COORDINATOR
      : BN_OVERALL_CONFIG_PATIENT
    : isCoordinator
      ? EN_OVERALL_CONFIG_COORDINATOR
      : EN_OVERALL_CONFIG_PATIENT;
  const UI = isBn
    ? isCoordinator
      ? BN_UI_COORDINATOR
      : BN_UI_PATIENT
  ...
  const handleBookTest = async (testName: string, price: string) => {
    try {
      ...
      if (data.success) {
        ...
        alert(
          lang === "bn"
            ? "টেস্ট সফলভাবে বুক করা হয়েছে!"
            : "Test successfully booked!",
        );
      } else {
...
[
  {
    ...
    "content": "English text here.\\n\\nবাংলা অনুবাদ এখানে।"
      ...
      if (!res.ok) {
        throw new Error(
          `Failed to generate prevention plan: ${res.statusText}`,
        );
      }
      ...
      try {
        ...
        console.warn(
          "Failed to parse reply as JSON. Attempting repair...",
          err,
        );
        ...
        if (!success) {
          ...
          const titles = [
            ...cleaned.matchAll(/"title"\s*:\s*"([^"\\]*(?:\\.[^"\\]*)*)"?/g),
          ];
          const contents = [
            ...cleaned.matchAll(/"content"\s*:\s*"([^"\\]*(?:\\.[^"\\]*)*)"?/g),
          ];
      ...
      setPlanError(
        err.message ||
          "Failed to connect to the clinical genomics copilot API. Please try again.",
      );
    } finally {
  ...
  if (loading) {
    const loadTitle = analysing
      ? isBn
        ? "🔬 আপনার ডিএনএ বিশ্লেষণ চলছে…"
        : "🔬 Analysing your DNA file…"
      : UI.loading;
    const loadHint = analysing
      ? isBn
        ? "আমাদের AI ইঞ্জিন আপনার ফাইল প্রক্রিয়া করছে। এটি সাধারণত ১৫-৩০ সেকেন্ড সময় নেয়। এই পেজটি স্বয়ংক্রিয়ভাবে আপডেট হবে।"
  ...
  return (
    <div className={styles.page}>
          ...
          <div>
            ...
            {meta && (
              <p className={styles.subtitle}>
                <span>
                  {UI.analyzedLabel} <strong>{meta.fileName}</strong>
                </span>
                <span className={styles.separator}>•</span>
                <span>
                  {UI.matchLabel} <strong>{meta.matchPct}%</strong>
                </span>
                <span className={styles.separator}>•</span>
                <span>
                  {UI.mutationsLabel} <strong>{meta.mutationCount}</strong>
                </span>
              </p>
            )}
          </div>
        ...
        <div className={styles.riskGrid}>
          {predictions.map((pred) => {
            ...
            return (
              <div
                key={pred.id}
                className={`${styles.riskCard} ${styles[`riskCard_${level}`]}`}
              >
                ...
                <div
                  style={{ display: "flex", gap: "0.5rem", margin: "0.4rem 0" }}
                >
                  <span
                    style={{
                      fontSize: "0.75rem",
      ...
      {!isCoordinator && meta?.organism && (
        <section style={{ marginTop: "1rem" }}>
          <h2 className={styles.sectionTitle}>
            {lang === "bn"
              ? "প্রস্তাবিত ক্লিনিক্যাল টেস্ট ও খরচ"
              : "Recommended Clinical Tests & Costs"}
          </h2>
              ...
              <div key={idx} className={styles.testCard}>
                ...
                <div className={styles.testFooter}>
                  ...
                  <button
                    ...
                    disabled={bookings.some((b) => b.test_name === test.name)}
                    className={styles.testBtn}
                  >
                    {bookings.some((b) => b.test_name === test.name)
                      ? lang === "bn"
                        ? "বুকড"
                        : "Booked"
                      : lang === "bn"
      ...
      {/* ── Receipt & Bill ────────────────────────────────────────── */}
      {!isCoordinator && bookings.length > 0 && (
        <section
          style={{
            marginTop: "2rem",
            border: "1px dashed var(--gn-surface-border-strong)",
            borderRadius: "16px",
            padding: "2rem",
        ...
        >
          <div
            style={{
              ...
              alignItems: "center",
              marginBottom: "1.5rem",
              borderBottom: "1px solid var(--gn-surface-border)",
              paddingBottom: "1rem",
            }}
          >
            <h2
            ...
            >
              {lang === "bn" ? "বুকিং সম্পন্ন" : "Booking Active"}
            </span>
          </div>
          ...
          >
            <thead>
              <tr
                style={{
                  borderBottom: "1px solid var(--gn-surface-border-strong)",
                  textAlign: "left",
                }}
              >
                <th
                ...
                >
                  {lang === "bn" ? "পরীক্ষার নাম" : "Test Name"}
                </th>
                <th
                  style={{
                    padding: "0.75rem 0",
              ...
              {bookings.map((booking, idx) => (
                ...
                >
                  ...
                  >
                    {lang === "bn"
                      ? booking.price
                      : formatPriceEn(parsePrice(booking.price))}
                  </td>
                </tr>
              ))}
            </tbody>
          ...
          <div
            style={{
              ...
              alignItems: "flex-end",
              borderTop: "2px solid var(--gn-surface-border-strong)",
              paddingTop: "1.5rem",
            }}
          >
            <div
              style={{ display: "flex", gap: "2rem", marginBottom: "0.5rem" }}
            >
              <span
                style={{ color: "var(--gn-text-secondary)", fontWeight: "600" }}
              >
              ...
              >
                {lang === "bn"
                  ? formatPriceBn(calculateTotalBill(bookings))
                  : formatPriceEn(calculateTotalBill(bookings))}
              </span>
            </div>
            <p
              style={{
            ...
            >
              {lang === "bn"
                ? "* হাসপাতাল কাউন্টারে পরীক্ষার পূর্বে বিল পরিশোধ করুন।"
                : "* Please pay this bill at the hospital counter prior to testing."}
            </p>
          </div>
        </section>
      )}
      ...
      <button
        ...
        title={
          isCoordinator
            ? isBn
              ? "পরীক্ষা ও ল্যাব সাজেশন দেখুন"
              : "View Tests & Labs Suggestion"
            : isBn
              ? "প্রতিরোধ ও সুস্থতা পরিকল্পনা দেখুন"
              : "View Prevention & Wellness Plan"
        }
      >
        <span>🔬</span>
        {isCoordinator
          ? isBn
            ? "টেস্ট ও ল্যাব সাজেশন"
            : "Tests & Labs Suggestion"
          : isBn
            ? "প্রতিরোধ ও সুস্থতা পরিকল্পনা"
            : "Prevention & Wellness Plan"}
      </button>
          ...
          >
            <div className={styles.modalHeader}>
              <h3 className={styles.modalTitle}>
                {isCoordinator
                  ? isBn
                    ? "প্রস্তাবিত পরীক্ষা এবং ল্যাবরেটরি"
                    : "Recommended Tests & Laboratories"
                  : isBn
                    ? "ব্যক্তিগত প্রতিরোধ ও সুস্থতা পরিকল্পনা"
                    : "Personal Prevention & Wellness Plan"}
              </h3>
              <button
            ...
            <div className={styles.planContent}>
              {loadingPlan && (
                ...
                >
                  ...
                  >
                    {isCoordinator
                      ? isBn
                        ? "পরীক্ষা ও ল্যাব সাজেশন তৈরি করা হচ্ছে..."
                        : "Generating tests & labs suggestions..."
                      : isBn
                        ? "সুস্থতা পরিকল্পনা তৈরি করা হচ্ছে..."
              ...
              {customPlan &&
                customPlan.map((section: any, idx: number) => (
